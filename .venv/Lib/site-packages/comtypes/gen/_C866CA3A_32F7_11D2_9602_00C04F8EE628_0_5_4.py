...
__all__ = [
    'DISPID_SpeechAudio', 'SPEVENTSOURCEINFO', 'DISPID_SPPChildren',
    'DISPID_SMSADeviceId', 'SpeechRuleState', 'SVP_12',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_PRIVATE16', 'SPAR_Low',
    'SpeechGrammarTagUnlimitedDictation', 'SPAS_PAUSE',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SOTGetDescription',
    'DISPID_SRCPause', 'ISpRecognizer', 'SAFT8kHz16BitStereo',
    'ISpPhraseAlt', 'DISPID_SDKDeleteKey', 'ISpRecoResult',
    'DISPID_SOTCategory', 'DISPID_SPARecoResult', 'SPBO_PAUSE',
    'ISpeechAudioBufferInfo', 'SPVISEMES', 'SRAExport',
    'DISPID_SLWLangId', 'DISPID_SPPs_NewEnum',
    'SpeechPropertyResourceUsage', 'SVSFIsNotXML', 'ISpAudio',
    'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPEsCount',
    'SPPHRASE', 'SP_VISEME_9', 'SREAudioLevel',
    'SPEI_RECO_STATE_CHANGE', 'SPSHT_OTHER', 'DISPID_SOTId',
    'SPWORDTYPE', 'DISPID_SPEPronunciation', 'SREPrivate',
    'SAFT22kHz8BitMono', 'DISPID_SGRSTsItem', 'DISPID_SRStatus',
    'SPPS_RESERVED1', 'SPEI_TTS_PRIVATE', 'SPFM_NUM_MODES',
    'SP_VISEME_19', 'DISPID_SVEventInterests', 'SAFT44kHz8BitMono',
    'DISPID_SPIEnginePrivateData', 'SPEI_MIN_TTS', 'SDTPronunciation',
    'DISPID_SpeechRecoResult', 'SpNullPhoneConverter',
    'DISPID_SRGState', 'SAFT48kHz8BitStereo', 'SPSERIALIZEDPHRASE',
    'DISPID_SVSVisemeId', 'SPPS_Modifier', 'DISPID_SOTsItem',
    'DISPID_SRRRecoContext', 'SGRSTTWildcard', 'SITooSlow',
    'SSSPTRelativeToCurrentPosition', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'tagSPPROPERTYINFO', 'SPSNotOverriden',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechLexiconPronunciation',
    'SAFTCCITT_uLaw_8kHzMono', 'SPAUDIOOPTIONS', 'SAFTText',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCCreateResultFromMemory', 'SAFTADPCM_22kHzStereo',
    'SECFIgnoreCase', 'SVEBookmark', 'DISPID_SPRs_NewEnum',
    'SpeechAudioProperties', 'SpeechStreamSeekPositionType',
    'DISPID_SRGCmdLoadFromObject', 'ISpVoice',
    'ISpObjectTokenCategory', 'eLEXTYPE_PRIVATE4', 'SGDisplay',
    ...
    'SGRSTTRule', 'SPINTERFERENCE_TOOFAST', 'DISPID_SpeechDataKey',
    'SPBOOKMARKOPTIONS', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechVoiceSpeakFlags', 'SDTAlternates',
    'ISpeechGrammarRuleStateTransitions', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRIsUISupported', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRGCommit', 'DISPID_SGRsDynamic',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRPhraseInfo', 'SRSEDone',
    'SPSHT_Unknown', 'DISPID_SOTGetStorageFileName', 'eLEXTYPE_APP',
    'SDTLexicalForm', 'DISPID_SLWsItem', 'DISPID_SVResume',
    'eLEXTYPE_PRIVATE11', 'SPPHRASEELEMENT',
    'DISPID_SpeechAudioFormat', 'DISPID_SASFreeBufferSpace', 'SVP_2',
    'SDTAll', 'DISPID_SLWsCount', 'ISpStream',
    'DISPID_SPEEngineConfidence', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTDefault', 'SLTUser', 'SPRS_ACTIVE', 'SVEEndInputStream',
    'SSTTTextBuffer', 'SAFTGSM610_22kHzMono',
    'DISPID_SPRules_NewEnum', 'SPEI_END_INPUT_STREAM', 'SRSInactive',
    'DISPID_SCSBaseStream', 'SPRST_INACTIVE',
    'DISPID_SpeechGrammarRuleState', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRSNumberOfActiveRules',
    'SP_VISEME_0', 'SpTextSelectionInformation', 'SRCS_Enabled',
    'DISPID_SVSpeakCompleteEvent', 'SINoise', 'DISPID_SRSAudioStatus',
    'DISPID_SPPsCount', 'SDKLCurrentUser', 'SREAdaptation',
    'SRSEIsSpeaking', 'STCAll', 'SPRULESTATE', 'SPEVENTENUM',
    '_SPAUDIOSTATE', 'SpFileStream', 'ISpSerializeState',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_8', '_RemotableHandle',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRsFindRule',
    'SPSERIALIZEDRESULT', 'SAFT32kHz16BitMono', 'DISPID_SLWType',
    'DISPID_SPPParent', 'SpeechCategoryAudioIn',
    ...
    'SpAudioFormat', 'SAFT16kHz16BitMono', 'DISPID_SLWPronunciations',
    'DISPID_SpeechLexiconWord', 'DISPID_SDKSetBinaryValue', 'SASRun',
    'SPGS_ENABLED', 'SPFILEMODE', 'SPSVerb', 'eLEXTYPE_PRIVATE2',
    'SP_VISEME_2', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_PRIVATE12', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVEPhoneme', 'DISPIDSPRG', 'DISPID_SRDisplayUI',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SWFESamplesPerSec',
    'SPWT_PRONUNCIATION', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SRADefaultToActive', 'DISPID_SVEEnginePrivate', 'SPXRO_SML',
    'SP_VISEME_16', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPFM_OPEN_READONLY', 'DISPID_SPIRule', 'SAFT44kHz16BitMono',
    'SAFTADPCM_22kHzMono', 'SPEI_UNDEFINED', 'DISPID_SLGenerationId',
    'ISpeechLexiconWords', 'ISpeechPhraseProperty',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCVoice',
    'SRTAutopause', 'SRESoundEnd', 'DISPID_SRRGetXMLResult',
    'SAFT24kHz8BitMono', 'SSSPTRelativeToStart',
    'ISpeechGrammarRules', 'SPSHORTCUTTYPE', 'SAFT8kHz8BitMono',
    'DISPID_SLWWord', 'DISPID_SDKCreateKey',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRName', 'SLODynamic',
    'DISPID_SPIProperties', 'DISPID_SPEs_NewEnum',
    'SPSHORTCUTPAIRLIST', 'DISPID_SLGetGenerationChange', 'SVP_18',
    'STCRemoteServer', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRSetPropertyString', 'ISpeechPhraseElements',
    'SPCONTEXTSTATE', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechBookmarkOptions', 'DISPID_SRCEInterference',
    'DISPID_SOTDataKey', 'WAVEFORMATEX', 'SASPause', 'ISpLexicon',
    'SECFDefault', 'SGRSTTWord', 'DISPID_SRGDictationUnload',
    'SPCS_ENABLED', 'DISPID_SPPName', 'SPDKL_CurrentConfig',
    'SpeechPropertyResponseSpeed', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechPhraseBuilder', 'SAFT48kHz16BitMono', 'SPWORD',
    'ISpeechPhraseReplacement', 'SPFM_CREATE_ALWAYS', 'SPRST_ACTIVE',
    'DISPID_SPEsItem', 'DISPID_SpeechLexicon', 'SLTApp',
    'eLEXTYPE_RESERVED8', 'DISPID_SPRuleChildren',
    'Speech_Max_Word_Length', 'SPPS_LMA', 'SPAUDIOSTATUS', 'SVP_11',
    'SpObjectTokenCategory', 'DISPID_SVEViseme', 'SSSPTRelativeToEnd',
    'DISPID_SPRuleId', 'DISPID_SDKEnumKeys',
    'DISPID_SVSLastBookmarkId', 'SREFalseRecognition',
    'SAFT22kHz16BitStereo', 'DISPID_SASCurrentDevicePosition',
    'SPSNoun', 'DISPID_SpeechGrammarRule', 'SSFMCreate',
    'DISPID_SOTSetId', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFT48kHz8BitMono', 'ISpeechLexiconWord', 'DISPID_SGRSTText',
    'DISPID_SPPFirstElement', 'DISPID_SLPSymbolic',
    'DISPID_SGRSTs_NewEnum', 'SPEI_SR_BOOKMARK', 'SPBINARYGRAMMAR',
    'Speech_Default_Weight', 'DISPID_SVEStreamEnd', 'SPVPRI_NORMAL',
    'DISPID_SPIGetText', 'SVEPrivate', 'ISpeechRecoResult2',
    'SREStreamStart', 'DISPID_SPIGrammarId', 'STCInprocHandler',
    'SpeechRegistryUserRoot', 'SpShortcut',
    'SpeechVoiceCategoryTTSRate', 'SPEI_RECOGNITION',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_PRIVATE1', 'DISPID_SRGReset',
    'SPAO_RETAIN_AUDIO', 'SREStateChange', 'DISPID_SVAudioOutput',
    'DISPID_SPERequiredConfidence', 'SVP_15', 'ISpNotifyTranslator',
    'SPEVENT', 'DISPID_SRCSetAdaptationData',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SVSpeak', 'ISpeechObjectTokens',
    'SAFT12kHz8BitMono', 'SpeechTokenKeyUI', 'SVEStartInputStream',
    'SAFTADPCM_11kHzStereo', 'SPVPRI_OVER', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTCSetId',
    'DISPID_SAFSetWaveFormatEx', 'SpObjectToken', 'SpeechLoadOption',
    'SDTRule', 'ISpeechRecoContext', 'SPEI_MAX_SR', 'SPAR_Medium',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechRecoResultTimes',
    'SAFTADPCM_44kHzMono', 'SVSFParseSapi',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGDictationSetState',
    'ISpPhrase', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechPhraseElement', 'DISPID_SPPId', 'SVP_0',
    'SP_VISEME_11', 'ISpeechLexiconPronunciations',
    'ISpeechPhraseInfo', 'SGSExclusive', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVIsUISupported', 'DISPID_SRCRequestedUIType',
    'DISPID_SASState', 'SpCompressedLexicon', 'DISPID_SPAsItem',
    'SRERecoOtherContext', 'DISPID_SPEDisplayText',
    'SpeechDiscardType', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SGRSTNextState', 'DISPID_SOTGetAttribute',
    'ISpeechPhraseRules', 'SPPS_SuppressWord', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPEDisplayAttributes', 'DISPID_SREmulateRecognition',
    'SVSFDefault', 'DISPIDSPTSI', 'SPSModifier', 'SWTDeleted',
    ...
    'SPWAVEFORMATTYPE', 'ISpeechGrammarRuleState', 'SPCT_COMMAND',
    'DISPID_SPPsItem', 'SPWORDPRONUNCIATION',
    'DISPID_SOTCEnumerateTokens', 'SPAR_Unknown', 'SDTDisplayText',
    'DISPID_SRGSetTextSelection', 'SPDKL_LocalMachine',
    'SPGS_EXCLUSIVE', 'ISpDataKey', 'SPDKL_DefaultLocation', 'SVP_6',
    'SAFT44kHz16BitStereo', 'ISpRecoGrammar',
    'DISPID_SVSRunningState', 'SAFT32kHz16BitStereo', 'SVP_17',
    'DISPID_SRCCreateGrammar', 'eLEXTYPE_RESERVED7', 'DISPID_SOTCId',
    'DISPID_SLPPhoneIds', 'DISPID_SLPs_NewEnum',
    'ISpeechRecognizerStatus', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRRTimes', 'DISPID_SGRsCount', 'IStream', 'SP_VISEME_3',
    'SRERecognition', 'SPCT_SLEEP', 'SpeechTokenKeyFiles',
    'SPLO_DYNAMIC', 'DISPID_SRCResume', 'DISPID_SPEAudioTimeOffset',
    'SRTExtendableParse', 'DISPID_SVAudioOutputStream',
    'SAFTExtendedAudioFormat', 'DISPID_SPRuleName', 'SDTReplacement',
    'SBOPause', 'DISPID_SDKGetBinaryValue', 'SFTInput',
    'SPGRAMMARSTATE', 'SVESentenceBoundary', 'SpeechEngineProperties',
    ...
    'DISPID_SPELexicalForm', 'SINoSignal', 'DISPID_SpeechRecognizer',
    'DISPID_SPRText', 'DISPID_SRGId', 'DISPID_SVSPhonemeId', 'SVP_14',
    'DISPID_SpeechPhraseProperty', 'DISPID_SGRSTPropertyValue',
    'SPSMF_SAPI_PROPERTIES', 'SAFTADPCM_11kHzMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVGetVoices', 'SDTProperty',
    'SpeechRecoEvents', '_ISpeechRecoContextEvents',
    'SpeechAudioVolume', 'DISPID_SpeechPhraseInfo', 'ISpRecognizer2',
    'ISpeechGrammarRule', 'SRESoundStart', 'SPLO_STATIC',
    'SVSFParseAutodetect', 'DISPID_SVSInputWordPosition',
    'ISpeechPhraseProperties', 'DISPID_SGRId', 'SRAONone',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SFSOpen',
    'DISPIDSPTSI_ActiveLength', 'SPEI_SOUND_START', 'SPVOICESTATUS',
    'SpeechGrammarState', 'SPWT_LEXICAL', 'SpeechDataKeyLocation',
    ...
    'DISPID_SBSRead', 'SP_VISEME_15', 'SpeechAudioState',
    'SpInprocRecognizer', 'SITooLoud', 'DISPID_SADefaultFormat',
    'SVPOver', 'DISPID_SPRDisplayAttributes', 'SpLexicon', 'SBONone',
    'tagSPTEXTSELECTIONINFO', 'Speech_StreamPos_RealTime', 'SVP_13',
    'SpeechTokenShellFolder', 'LONG_PTR', 'SGDSActive',
    'DISPID_SVVoice', 'ISpeechRecoGrammar', 'SINone',
    'DISPID_SGRSTPropertyName', 'SPEI_SENTENCE_BOUNDARY',
    'ISpStreamFormat', 'SPCT_SUB_DICTATION', 'DISPID_SRRAudioFormat',
    'DISPID_SPIAudioStreamPosition', 'SpeechWordPronounceable',
    'SpeechCategoryVoices', 'STSF_CommonAppData',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpObjectToken', 'SDA_One_Trailing_Space', 'SPBO_NONE',
    'SP_VISEME_6', 'SpeechEngineConfidence', 'eLEXTYPE_PRIVATE7',
    'SVSFIsFilename', 'DISPID_SGRsCommitAndSave',
    'ISpeechCustomStream', 'DISPID_SLGetWords',
    'ISpStreamFormatConverter', 'SSFMCreateForWrite', 'SFTSREngine',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SLPLangId',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechVoice', 'IEnumString',
    'eLEXTYPE_PRIVATE13', 'DISPID_SOTIsUISupported',
    'DISPID_SRCESoundEnd', 'DISPID_SBSSeek', 'SPEI_RESERVED1',
    'ISpeechVoiceStatus', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechRecognizerStatus', 'STSF_AppData', 'DISPID_SVRate',
    'SpeechDictationTopicSpelling', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SFSClose', 'DISPID_SVDisplayUI', 'ISpMMSysAudio',
    'SECHighConfidence', 'ISpeechVoice', 'SVF_Stressed',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechRecoContextState',
    'DISPID_SPCLangId', 'DISPID_SDKDeleteValue', 'SVEWordBoundary',
    ...
    'SREBookmark', 'DISPID_SLPType', 'ISpeechDataKey', 'SPSUnknown',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPIAudioSizeBytes',
    'SPVPRIORITY', 'DISPID_SPEActualConfidence', 'SP_VISEME_5',
    'DISPID_SRGetRecognizers', 'SAFTGSM610_44kHzMono',
    ...
    'DISPID_SRRTLength', 'SPPS_NotOverriden', 'SPEI_RESERVED2',
    'DISPID_SVEPhoneme', 'SVSFIsXML', 'SPWF_INPUT',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_USER',
    'DISPID_SWFEChannels', 'SGSDisabled', 'DISPID_SLPPartOfSpeech',
    'DISPID_SASetState', 'SPEI_ADAPTATION', 'SAFT11kHz16BitMono',
    'SRADynamic', 'eLEXTYPE_USER_SHORTCUT', 'SPINTERFERENCE_NONE',
    'SAFT44kHz8BitStereo', 'ISequentialStream', 'DISPID_SBSWrite',
    'SpStream', 'SPAUDIOBUFFERINFO', 'SpUnCompressedLexicon',
    'DISPID_SpeechObjectTokens', 'eLEXTYPE_PRIVATE17',
    'SAFT24kHz16BitMono', 'SVSFParseSsml', 'SPCT_DICTATION',
    'DISPID_SVPause', 'DISPID_SMSAMMHandle',
    'IInternetSecurityMgrSite', 'DISPID_SVPriority',
    'SPRECOCONTEXTSTATUS', 'SPEI_HYPOTHESIS',
    ...
    'ISpeechPhraseRule', 'SpVoice', 'DISPID_SRState',
    'SDKLCurrentConfig', 'DISPID_SRCEAudioLevel', 'DISPID_SGRClear',
    'SECFIgnoreKanaType', 'SPPS_Unknown', 'ISpeechMMSysAudio',
    'SPPHRASERULE', 'DISPID_SPRuleEngineConfidence', 'SPSHT_EMAIL',
    ...
    'DISPID_SpeechPhraseRules', 'SVSFVoiceMask', 'SVP_21',
    'DISPID_SLPsItem', 'SpWaveFormatEx', 'DISPID_SMSGetData',
    'DISPID_SpeechCustomStream', 'SPPS_Verb',
    'DISPID_SDKGetlongValue', 'SREInterference', 'SPRST_NUM_STATES',
    'SVF_Emphasis', 'DISPID_SVEAudioLevel', 'DISPID_SPRsCount',
    'SPAS_RUN', 'DISPID_SPRsItem', 'SPAUDIOSTATE',
    'ISpeechWaveFormatEx', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SGRInitialState', 'SP_VISEME_7', 'SPEI_TTS_BOOKMARK',
    'SAFTADPCM_8kHzMono', 'SPPS_RESERVED2', 'SVEVoiceChange',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechLexiconType',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SGRsCommit', 'DISPID_SGRSTRule',
    'DISPID_SPAStartElementInResult', 'DISPID_SPIReplacements',
    'SPAS_STOP', 'DISPID_SRCEPhraseStart', 'SpeechGrammarTagWildcard',
    'DISPID_SVSInputWordLength', 'SRARoot', 'SPEI_START_INPUT_STREAM',
    'SRTReSent', 'STSF_LocalAppData', 'SP_VISEME_4',
    'SPDKL_CurrentUser', 'DISPID_SDKSetStringValue', 'SRSActive',
    'SVP_1', 'Speech_Max_Pron_Length', 'SPXMLRESULTOPTIONS',
    'SpeechMicTraining', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SAFType',
    'SRCS_Disabled', 'SpMemoryStream', 'DISPID_SRCEStartStream',
    'SECLowConfidence', 'SpeechAllElements', 'SPINTERFERENCE_NOISE',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRGDictationLoad',
    'DISPID_SPIAudioSizeTime', 'SDKLDefaultLocation', 'SP_VISEME_13',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'IEnumSpObjectTokens',
    'DISPID_SRCRecognizer', 'DISPID_SMSSetData', 'ISpeechAudio',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVPNormal',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechGrammarRules',
    'eLEXTYPE_PRIVATE14', 'ISpeechPhraseElement', 'SPAR_High',
    'SpeechRuleAttributes', 'DISPID_SDKEnumValues', 'SPSInterjection',
    'DISPID_SWFEBlockAlign', 'DISPID_SVStatus',
    'DISPID_SpeechRecoContext', 'DISPID_SVVolume',
    'ISpeechPhoneConverter', 'SLOStatic', 'SITooFast',
    'DISPID_SGRSTsCount', 'DISPID_SRAudioInput',
    'DISPID_SpeechPhraseReplacements', 'SVF_None', 'SASClosed',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPRS_INACTIVE',
    'DISPID_SASCurrentSeekPosition', 'ISpeechRecoResultDispatch',
    'SGDSActiveWithAutoPause', 'SDTAudio', 'SAFT12kHz16BitMono',
    'ISpNotifySource', 'SpNotifyTranslator', 'SpSharedRecognizer',
    'DISPID_SRCEventInterests', 'DISPID_SRRSaveToMemory',
    'SPVPRI_ALERT', 'SREPropertyStringChange', 'DISPID_SVEBookmark',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRCERequestUI', 'SRAInterpreter', 'SRTStandard',
    'eLEXTYPE_RESERVED6', 'DISPID_SRGetPropertyNumber',
    ...
    'DISPID_SOTCreateInstance', 'DISPID_SPILanguageId', 'SPAO_NONE',
    'SPWF_SRENGINE', 'SPTEXTSELECTIONINFO', 'eLEXTYPE_LETTERTOSOUND',
    'SP_VISEME_18', 'ISpXMLRecoResult', 'DISPID_SWFEBitsPerSample',
    'SpeechUserTraining', 'DISPID_SpeechAudioBufferInfo',
    'ISpRecoContext', 'ISpeechLexicon', 'SVP_3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpMMAudioOut',
    'SpeechRunState', 'SWTAdded', 'DISPID_SRGRules',
    'ISpeechXMLRecoResult', 'SPEI_PHRASE_START', 'SPSFunction',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPEAudioStreamOffset',
    'SpResourceManager', 'eLEXTYPE_PRIVATE15', 'SpeechWordType',
    'SpeechDisplayAttributes', 'ISpeechBaseStream', 'SPEI_RESERVED6',
    'SpeechPropertyAdaptationOn', 'DISPID_SRRecognizer',
    'SpInProcRecoContext', 'SAFT32kHz8BitStereo', 'SVP_10',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRSetPropertyNumber',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SOTs_NewEnum',
    'SPEI_END_SR_STREAM', 'eWORDTYPE_DELETED',
    'SWPUnknownWordUnpronounceable', 'eLEXTYPE_PRIVATE8',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPCT_SUB_COMMAND',
    'DISPID_SDKGetStringValue', 'SSFMOpenReadWrite', 'SREHypothesis',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVSkip', 'SPEI_VOICE_CHANGE', 'SPAS_CLOSED',
    'DISPID_SRRAudio', 'SpeechRetainedAudioOptions', 'SVSFNLPMask',
    'DISPID_SAFGuid', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCERecognitionForOtherContext', 'SGPronounciation',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRAttributes',
    'SPEI_SR_PRIVATE', 'SP_VISEME_17', 'DISPID_SVESentenceBoundary',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRGCmdSetRuleState',
    'SVSFNLPSpeakPunc', 'ISpeechGrammarRuleStateTransition',
    'SPSTREAMFORMATTYPE', 'SAFTCCITT_ALaw_22kHzMono', 'SRTEmulated',
    'SPCS_DISABLED', 'DISPID_SPRuleFirstElement',
    'DISPID_SPRuleParent', 'ISpeechTextSelectionInformation',
    'DISPID_SRGIsPronounceable', 'SpeechInterference',
    'SpeechRecognitionType', 'ISpRecoContext2',
    'SPEI_FALSE_RECOGNITION', 'SPPHRASEPROPERTY',
    'SpeechAddRemoveWord', 'eLEXTYPE_PRIVATE3', 'DISPID_SOTDisplayUI',
    'DISPID_SVEWord', 'SGRSTTDictation', 'SPGRAMMARWORDTYPE',
    'SpeechTokenValueCLSID', 'SGDSInactive', 'SPRECOSTATE',
    'SRSActiveAlways', 'DISPID_SVEVoiceChange', 'SPFM_OPEN_READWRITE',
    'DISPID_SPIRetainedSizeBytes', 'SRSInactiveWithPurge',
    'SpeechCategoryAppLexicons', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_VISEME', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPPValue',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPACommit',
    'DISPID_SVSCurrentStreamNumber', 'SVEAllEvents', 'SPGS_DISABLED',
    'STSF_FlagCreate', 'SPPS_Noncontent', 'SPINTERFERENCE',
    'SAFT32kHz8BitMono', 'DISPID_SOTCDefault', 'DISPID_SAStatus',
    'SPSEMANTICFORMAT', 'DISPID_SVAlertBoundary',
    ...
    'SSTTWildcard', 'DISPID_SVEStreamStart', 'SRERequestUI',
    'DISPID_SGRSAddWordTransition', 'SVP_4',
    'DISPID_SpeechRecoResultTimes', 'SpeechCategoryAudioOut',
    'SPFM_CREATE', 'SECFNoSpecialChars', 'DISPID_SOTsCount',
    'eLEXTYPE_PRIVATE9', 'SAFTNoAssignedFormat',
    'SpeechVoicePriority', 'DISPID_SRRSetTextFeedback', 'SVP_8',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechRecoProfileProperties', 'DISPID_SpeechMMSysAudio',
    'ISpPhoneConverter', 'DISPID_SpeechObjectToken',
    'DISPID_SRCVoicePurgeEvent', 'SPLOADOPTIONS', 'SVP_9',
    'eLEXTYPE_PRIVATE10', 'DISPID_SABIBufferSize', 'ISpShortcut',
    'SVEViseme', 'SPEI_PHONEME', 'SP_VISEME_20', 'DISPID_SPRulesItem',
    'SPBO_AHEAD', 'SPPS_Interjection', 'DISPID_SAVolume',
    'DISPID_SGRSTWeight', '_ISpeechVoiceEvents', 'SRAImport',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_Noun',
    'eLEXTYPE_PRIVATE5', 'SPINTERFERENCE_TOOLOUD', 'SASStop',
    'SAFTNonStandardFormat', 'SpeechTokenIdUserLexicon',
    'SDA_No_Trailing_Space', 'DISPID_SGRSAddRuleTransition',
    'SPEI_START_SR_STREAM', 'DISPID_SLGetPronunciations',
    'SPEI_REQUEST_UI', 'SREPropertyNumChange',
    'DISPID_SpeechFileStream', 'SVSFPersistXML', 'SGLexical',
    ...
    'SP_VISEME_21', 'DISPID_SGRSTType', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT16kHz8BitMono', 'eLEXTYPE_RESERVED10', 'SpeechVisemeFeature',
    ...
    'SGRSTTEpsilon', 'DISPID_SRCEFalseRecognition',
    'SpeechPartOfSpeech', 'SPSHORTCUTPAIR', 'SPEI_RESERVED5',
    'DISPID_SPRuleConfidence', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRGetFormat', 'SP_VISEME_1', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechRecoContextEvents', 'SpMMAudioEnum',
    'SPRECORESULTTIMES', 'SAFT16kHz8BitStereo', 'DISPID_SBSFormat',
    'ISpeechPhraseAlternates', 'SPEI_MIN_SR', 'DISPID_SLPsCount',
    'SAFT22kHz16BitMono', 'DISPID_SOTCGetDataKey',
    'SAFTGSM610_11kHzMono', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPCIdToPhone', 'SDKLLocalMachine',
    'DISPID_SRCRetainedAudioFormat', 'SpCustomStream',
    'ISpRecoGrammar2', 'STCLocalServer', 'DISPID_SDKOpenKey',
    'ISpeechResourceLoader', 'ISpEventSource', 'SVP_16',
    'SPLEXICONTYPE', 'SAFT8kHz16BitMono', 'ISpEventSink',
    'DISPID_SRRAlternates', 'DISPID_SGRAddState',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPAsCount',
    'SPCATEGORYTYPE', 'SPWORDLIST', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRCEBookmark', 'ISpeechPhraseReplacements',
    'DISPID_SAEventHandle', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechAudioStatus',
    'SAFT24kHz16BitStereo', 'SpeechFormatType', 'DISPID_SABufferInfo',
    'DISPID_SRCEEndStream', 'DISPID_SPRNumberOfElements',
    'DISPID_SVSLastResult', 'DISPID_SVGetProfiles', 'SPEI_RESERVED3',
    'DISPID_SPPConfidence', 'SGLexicalNoSpecialChars',
    'DISPID_SpeechMemoryStream', 'SVP_7', 'SAFTGSM610_8kHzMono',
    'SpeechAudioFormatType', 'SpStreamFormatConverter',
    'DISPID_SRRTTickCount', 'SAFT11kHz16BitStereo',
    'SAFT22kHz8BitStereo', 'UINT_PTR', 'SGSEnabled',
    'SAFT48kHz16BitStereo', 'SPPHRASEREPLACEMENT',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPRuleNumberOfElements',
    'SPEI_MAX_TTS', 'DISPID_SVSpeakStream', 'DISPID_SVGetAudioInputs',
    'DISPID_SRIsShared', 'SPSMF_UPS', 'SVPAlert',
    'SPRECOGNIZERSTATUS', 'ISpPhoneticAlphabetSelection',
    'SPWT_DISPLAY', 'SPEI_SOUND_END', 'ISpProperties',
    'ISpeechAudioStatus', 'DISPID_SGRs_NewEnum', 'SITooQuiet',
    'SpeechVoiceEvents', 'ISpeechPhraseAlternate',
    'SpeechTokenKeyAttributes', 'SPPS_RESERVED3', 'DISPID_SGRSRule',
    'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_12',
    'SAFT11kHz8BitStereo', 'SREStreamEnd', 'SGDSActiveUserDelimited',
    'ISpeechRecoResult', 'SPPROPERTYINFO', 'SPINTERFERENCE_TOOQUIET',
    'SWPUnknownWordPronounceable', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCESoundStart', 'DISPID_SRCEHypothesis',
    'SAFTADPCM_44kHzStereo', 'SRTSMLTimeout', 'eWORDTYPE_ADDED',
    'SpeechGrammarWordType', 'DISPID_SLAddPronunciation',
    'SVSFUnusedFlags', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechStreamFileMode', 'SVSFlagsAsync', 'SVP_20', 'SVP_5',
    'ISpResourceManager', 'SPPS_Function', 'DISPID_SASNonBlockingIO',
    'DISPID_SMSALineId', 'SAFTCCITT_ALaw_11kHzStereo',
    'SGRSTTTextBuffer', 'DISPID_SPIGetDisplayAttributes',
    'ISpeechMemoryStream', 'DISPID_SRCBookmark', 'SP_VISEME_14',
    'SECNormalConfidence', 'SPSLMA', 'DISPID_SPRulesCount',
    'DISPID_SpeechXMLRecoResult', 'ISpeechRecognizer', 'SPRULE',
    'DISPID_SPPNumberOfElements', 'SP_VISEME_10',
    'DISPID_SPIElements', 'SSTTDictation', 'DISPID_SRGRecoContext',
    'ISpRecoCategory', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechRecognizerState', 'SECFIgnoreWidth',
    'DISPID_SpeechBaseStream', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCEPropertyStringChange', 'SpeechEmulationCompareFlags',
    'SpPhraseInfoBuilder', 'DISPID_SRCState', 'SAFT12kHz8BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SABIEventBias',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechTokenContext',
    'SPXRO_Alternates_SML', 'SPEI_SR_AUDIO_LEVEL', 'ISpRecognizer3',
    'DISPID_SPIEngineId', 'SAFT11kHz8BitMono', 'SAFT16kHz16BitStereo',
    'ISpNotifySink', 'STCInprocServer', 'SVP_19',
    'DISPID_SPAs_NewEnum', 'SECFEmulateResult', 'SPPS_RESERVED4',
    'SpMMAudioIn'
]

_check_version('1.1.14', 1617974495.156446)
