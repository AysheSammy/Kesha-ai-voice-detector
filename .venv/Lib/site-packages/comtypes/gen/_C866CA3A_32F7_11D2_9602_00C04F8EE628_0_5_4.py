...
__all__ = [
    'SAFTADPCM_22kHzMono', 'ISpRecoResult',
    'ISpeechLexiconPronunciation', 'SpResourceManager',
    'STCRemoteServer', 'SpeechPropertyNormalConfidenceThreshold',
    'SPEI_WORD_BOUNDARY', 'SVEVoiceChange', 'DISPID_SRGetRecognizers',
    'DISPID_SLWType', 'SVEPrivate', 'eLEXTYPE_PRIVATE12',
    'STCLocalServer', 'SpWaveFormatEx', 'SREPropertyNumChange',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRsDynamic', 'DISPID_SLPsItem',
    'DISPID_SRGCmdSetRuleState', 'SAFT16kHz8BitStereo', 'SGLexical',
    'DISPID_SGRSAddWordTransition', 'SAFTCCITT_ALaw_8kHzStereo',
    'SGSDisabled', 'DISPID_SpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED4', 'SPSInterjection', 'SP_VISEME_14',
    'eLEXTYPE_APP', 'DISPID_SADefaultFormat', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SABufferInfo', 'DISPID_SPRulesCount',
    'SpeechRecoContextState', 'DISPID_SGRId', 'SSFMCreateForWrite',
    'SGSExclusive', 'DISPID_SRRSpeakAudio',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVVoice',
    'eLEXTYPE_PRIVATE4', 'eLEXTYPE_PRIVATE8', 'SVP_8', 'SPWT_DISPLAY',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpeechPhraseProperties', '_SPAUDIOSTATE',
    'DISPID_SGRSAddRuleTransition', 'SpPhoneConverter', 'SPSFunction',
    'SREPropertyStringChange', 'SAFT22kHz16BitStereo', 'SPWT_LEXICAL',
    'SDA_One_Trailing_Space', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPIElements', 'SAFT32kHz16BitStereo', 'SRAImport',
    'SVP_15', 'DISPID_SpeechCustomStream', 'DISPID_SpeechRecognizer',
    'DISPID_SWFEChannels', 'SPEI_VISEME', 'DISPID_SRCESoundStart',
    'DISPID_SMSSetData', 'SPFM_OPEN_READONLY', 'SpMemoryStream',
    'SPEI_START_INPUT_STREAM', 'SRSEIsSpeaking', 'DISPID_SVEViseme',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechRecoContextEvents',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPLO_DYNAMIC', 'SPEI_SOUND_END',
    'SWPUnknownWordUnpronounceable', 'SPEVENTSOURCEINFO',
    'DISPID_SASNonBlockingIO', 'SpMMAudioIn',
    'DISPID_SpeechLexiconProns', 'SP_VISEME_6', 'STSF_FlagCreate',
    'SpeechVoicePriority', 'ISpeechLexiconWords',
    'SPFM_OPEN_READWRITE', 'SPEI_UNDEFINED',
    'DISPID_SpeechFileStream', 'eLEXTYPE_PRIVATE9', 'SRCS_Disabled',
    'SDTPronunciation', 'DISPID_SOTGetDescription',
    'DISPID_SGRAttributes', 'eLEXTYPE_RESERVED9',
    'SpStreamFormatConverter', 'SPPHRASEREPLACEMENT',
    'ISpObjectToken', 'STCAll', 'SVP_3', 'SpSharedRecoContext',
    ...
    'SVSFVoiceMask', 'DISPID_SPPName', 'DISPID_SRRAudioFormat',
    'ISpeechVoice', 'SAFT22kHz8BitMono', 'DISPID_SRRTTickCount',
    'SECLowConfidence', 'SVEAudioLevel', 'DISPID_SPAsCount',
    'SpeechStreamSeekPositionType', 'SVEViseme', 'SRESoundEnd',
    'SPEI_VOICE_CHANGE', 'DISPID_SLRemovePronunciation', 'SPWORDLIST',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPEI_TTS_PRIVATE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SGPronounciation',
    'SREAudioLevel', 'DISPID_SRGCommit', 'SVP_9',
    'DISPID_SGRAddState', 'SWPUnknownWordPronounceable',
    'tagSPTEXTSELECTIONINFO', 'ISpPhoneticAlphabetSelection',
    'DISPID_SWFEBitsPerSample', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SDKCreateKey',
    'SAFT8kHz16BitStereo', 'ISpeechObjectTokens', 'DISPID_SPRsCount',
    'DISPID_SDKSetLongValue', 'SAFTADPCM_11kHzStereo',
    'SPCT_SUB_DICTATION', 'SVPOver', 'DISPID_SRCEBookmark',
    'DISPID_SWFEExtraData', 'DISPID_SPELexicalForm',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT32kHz16BitMono',
    'SAFTADPCM_8kHzMono', 'SpeechDisplayAttributes', 'SPRS_ACTIVE',
    'SPCT_SUB_COMMAND', 'DISPID_SRCERecognizerStateChange',
    'SVSFParseSsml', 'DISPID_SPRuleName', 'SRCS_Enabled', 'ISpVoice',
    'DISPID_SLGenerationId', 'SpAudioFormat',
    'SPEI_FALSE_RECOGNITION', 'SITooSlow', 'SDA_No_Trailing_Space',
    'DISPID_SOTsItem', 'SPCS_DISABLED', 'DISPID_SpeechPhraseElements',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPISaveToMemory', 'DISPID_SRCEPhraseStart',
    'SAFT44kHz16BitMono', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SVGetProfiles', 'DISPID_SPPsCount',
    'DISPID_SpeechMemoryStream', 'SAFT22kHz8BitStereo', 'SVF_None',
    'ISpeechPhraseProperty', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPVPRI_NORMAL', 'DISPID_SVEPhoneme', 'DISPID_SPIAudioSizeBytes',
    'eLEXTYPE_VENDORLEXICON', 'SpeechPropertyResponseSpeed',
    'SpPhraseInfoBuilder', 'SPSHT_EMAIL', 'SAFTNonStandardFormat',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechPhraseElement',
    'eLEXTYPE_RESERVED8', 'SGRSTTRule', 'DISPID_SPRText', 'SVSFIsXML',
    'DISPID_SVEStreamEnd', 'DISPID_SPAsItem', 'DISPID_SVStatus',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVP_20',
    'DISPID_SLWPronunciations', 'SLODynamic',
    'DISPID_SPEActualConfidence', 'SpeechCategoryAppLexicons',
    'DISPID_SGRsItem', 'ISpeechPhoneConverter', 'SPVOICESTATUS',
    'SECFDefault', 'SVSFDefault', 'ISpeechMemoryStream',
    'tagSPPROPERTYINFO', 'SREAllEvents', 'DISPID_SRGetPropertyNumber',
    'SPVPRI_OVER', 'SPAO_RETAIN_AUDIO', 'DISPID_SpeechObjectToken',
    'SPFM_NUM_MODES', 'SPRECOCONTEXTSTATUS', 'DISPID_SDKGetlongValue',
    'UINT_PTR', 'DISPID_SVDisplayUI', 'DISPID_SRCPause',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE19',
    'eWORDTYPE_DELETED', 'eLEXTYPE_PRIVATE18', 'SAFTNoAssignedFormat',
    'SGDisplay', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SpeechPhraseAlternate', 'eLEXTYPE_MORPHOLOGY',
    'SGRSTTEpsilon', 'DISPID_SDKGetStringValue',
    'DISPID_SpeechObjectTokenCategory', 'ISpObjectWithToken',
    'SpeechAllElements', 'SpTextSelectionInformation',
    'SpeechPropertyResourceUsage', 'SREAdaptation',
    'DISPID_SOTGetStorageFileName', 'SAFTGSM610_44kHzMono',
    'DISPID_SPIAudioSizeTime', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVAudioOutput', 'SpeechVisemeType', 'tagSTATSTG',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SMSGetData',
    'DISPID_SVSpeak', 'DISPID_SGRAddResource',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_PHONEME', 'SVF_Stressed',
    'DISPID_SRCCreateGrammar', 'SPWORDPRONUNCIATION',
    'SpeechLoadOption', 'SAFTGSM610_22kHzMono',
    'SPSMF_SAPI_PROPERTIES', 'SpeechFormatType', 'SVEBookmark',
    'DISPID_SVSLastBookmarkId', 'SPBO_TIME_UNITS', 'SPGS_DISABLED',
    'SPVPRIORITY', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPRuleChildren', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SOTId', 'DISPID_SLWsCount', 'SDTDisplayText',
    'DISPID_SpeechAudioStatus', 'SVSFParseMask', 'SP_VISEME_18',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SDKSetStringValue', 'SpeechStreamFileMode', 'DISPIDSPRG',
    'DISPID_SRRecognizer', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPCIdToPhone', 'SP_VISEME_2', 'SDTReplacement',
    'eLEXTYPE_PRIVATE14', 'SLTUser', 'SVP_5',
    'DISPID_SRCSetAdaptationData',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechRecoContext', 'DISPID_SPCLangId', 'SPWT_PRONUNCIATION',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SGRSTType', 'ISpRecoGrammar', 'SVSFUnusedFlags',
    'DISPID_SVESentenceBoundary', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEVENT', 'SpeechVoiceEvents', 'SpeechRegistryUserRoot',
    'DISPID_SRGDictationSetState', 'SP_VISEME_4', 'ISpRecoGrammar2',
    'SAFT32kHz8BitMono', 'SAFT16kHz8BitMono', 'DISPID_SAVolume',
    'ISpeechGrammarRules', 'ISpRecoContext', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechPhraseRules', 'SPPS_Function', 'SRAONone',
    'DISPID_SPIStartTime', 'DISPID_SPRules_NewEnum',
    'SGDSActiveWithAutoPause', 'SPEI_MAX_TTS', 'DISPID_SPPs_NewEnum',
    'ISpeechRecoResult2', 'DISPID_SRCVoicePurgeEvent', 'SPVISEMES',
    'SREPrivate', 'DISPID_SVEEnginePrivate', 'SpeechTokenValueCLSID',
    'DISPID_SpeechPhraseRule', 'SSTTDictation',
    '__MIDL_IWinTypes_0009', 'DISPID_SASState',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTText', 'SDTLexicalForm',
    'STCInprocHandler', 'DISPID_SGRClear', 'IEnumString',
    'SPINTERFERENCE', 'SP_VISEME_15', 'SVP_7',
    'DISPID_SRGCmdLoadFromObject', 'SAFT48kHz16BitStereo',
    'SPEI_END_INPUT_STREAM', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRSTRule', 'SSSPTRelativeToStart', 'ISpeechFileStream',
    'SVP_18', 'SAFT48kHz16BitMono', 'SREInterference',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SpeechAudioFormat',
    'DISPID_SOTCGetDataKey', 'DISPID_SRGRules',
    'DISPID_SRCEPropertyStringChange', 'SSTTWildcard',
    'SPWAVEFORMATTYPE', 'SPSModifier', 'ISpeechAudioStatus',
    'DISPID_SGRSTText', 'SVSFParseSapi', 'SPPS_Verb',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCERequestUI',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPPParent',
    'DISPID_SWFEFormatTag', 'SpeechPartOfSpeech', 'SpLexicon',
    'SPAR_Medium', 'ISpResourceManager', 'ISpeechPhraseRule',
    'DISPID_SLPsCount', 'SpeechAudioVolume', 'DISPID_SOTDisplayUI',
    'STCInprocServer', 'SpNullPhoneConverter',
    'DISPID_SpeechPhraseAlternates', 'eLEXTYPE_PRIVATE7',
    'ISpeechAudioBufferInfo', 'SPXRO_SML', 'DISPID_SPPConfidence',
    'SPRECOSTATE', 'DISPID_SPERetainedSizeBytes', 'SSFMOpenReadWrite',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioFormatGUIDWave',
    'DISPID_SOTIsUISupported', 'ISpGrammarBuilder', 'SPGS_EXCLUSIVE',
    ...
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRGSetWordSequenceData',
    'ISpRecognizer2', 'DISPID_SGRSTsCount', 'SpeechTokenContext',
    'DISPID_SRIsUISupported', 'SpeechRecognizerState',
    'DISPID_SRCState', 'SP_VISEME_1', 'SpeechAudioFormatGUIDText',
    'SP_VISEME_20', 'SINoSignal', 'DISPID_SRSSupportedLanguages',
    'SpCompressedLexicon', 'DISPID_SVIsUISupported',
    'SpInProcRecoContext', 'DISPID_SRRTLength', 'DISPID_SLWsItem',
    'SLTApp', 'DISPID_SRCVoice', 'DISPID_SRGReset',
    'DISPID_SDKSetBinaryValue', 'SAFTADPCM_8kHzStereo', 'SP_VISEME_0',
    'DISPID_SRRRecoContext', 'SPFM_CREATE_ALWAYS',
    'SAFT12kHz16BitMono', 'SPSHORTCUTPAIR', 'SDKLCurrentConfig',
    'DISPID_SOTCSetId', 'DISPID_SVSLastResult', 'ISpStream',
    'DISPID_SFSClose', 'SpUnCompressedLexicon', 'SPWORDTYPE',
    'DISPID_SPANumberOfElementsInResult', 'SAFTGSM610_8kHzMono',
    'SDA_Two_Trailing_Spaces', 'SPXRO_Alternates_SML', 'SVP_6',
    'eLEXTYPE_USER', 'DISPID_SPACommit', 'DISPID_SRCEventInterests',
    'SVEAllEvents', 'ISpeechRecoResult', 'DISPID_SVPause',
    'DISPID_SGRSTsItem', 'eWORDTYPE_ADDED',
    'DISPID_SRGCmdSetRuleIdState', 'SECFEmulateResult',
    'DISPID_SRRTOffsetFromStart', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SMSALineId', 'DISPID_SOTsCount', 'ISpeechResourceLoader',
    'DISPID_SGRSAddSpecialTransition', 'SPAR_Low', 'SVP_11',
    'DISPID_SGRName', 'SAFTCCITT_ALaw_22kHzMono', 'SpeechAudioState',
    'DISPID_SVEBookmark', 'SWTAdded', 'DISPID_SOTDataKey',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRGetFormat',
    'SAFT44kHz8BitStereo', 'SP_VISEME_11', 'DISPID_SPPId',
    ...
    'DISPID_SRGetPropertyString', 'SAFT11kHz8BitMono', 'SITooFast',
    'ISpeechObjectTokenCategory', 'SRERecognition', 'SREStreamEnd',
    'DISPID_SLWs_NewEnum', 'ISpRecognizer3', 'SVP_1',
    'DISPID_SVEAudioLevel', 'DISPID_SREmulateRecognition',
    'SpeechGrammarState', 'SBOPause', 'ISpeechCustomStream',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechRecoResult',
    'SVESentenceBoundary', 'SAFT12kHz8BitMono', 'SVP_14',
    'DISPID_SPIEngineId', 'DISPID_SGRsFindRule', 'ISpXMLRecoResult',
    'ISpeechPhraseAlternates', 'SpeechVoiceSpeakFlags',
    'SPSHORTCUTPAIRLIST', 'SpVoice', 'SGSEnabled', 'SP_VISEME_21',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCEEndStream',
    'DISPID_SVEStreamStart', 'SRAInterpreter',
    'ISpeechRecognizerStatus', 'SPDATAKEYLOCATION',
    'DISPID_SRDisplayUI', 'DISPID_SRSNumberOfActiveRules',
    'SPAUDIOSTATUS', 'DISPID_SPERequiredConfidence',
    'DISPID_SPRulesItem', 'SPDKL_CurrentConfig', 'SPLO_STATIC',
    'SRARoot', 'SpMMAudioOut', 'DISPID_SLPType',
    'SPDKL_DefaultLocation', 'SPLEXICONTYPE', 'SREBookmark',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpAudio',
    'DISPID_SRSClsidEngine', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechLexicon', 'SAFT11kHz16BitStereo', 'SPAS_RUN',
    'DISPID_SPPsItem', 'SpShortcut', 'SVP_12',
    'SpeechCategoryAudioIn', 'SpeechSpecialTransitionType',
    'DISPID_SRGRecoContext', 'SRATopLevel',
    'DISPID_SPRNumberOfElements', 'SINone', 'SPEI_RESERVED6',
    'SPEI_TTS_BOOKMARK', 'SAFTADPCM_11kHzMono', 'DISPID_SRRTimes',
    'SpeechDataKeyLocation', 'IInternetSecurityMgrSite',
    'ISpNotifyTranslator', 'SPPS_Modifier', 'SPSNotOverriden',
    'SDTAll', 'ISpeechObjectToken', 'eLEXTYPE_PRIVATE6',
    'SGRSTTTextBuffer', 'SpeechRetainedAudioOptions',
    'SREStateChange', 'eLEXTYPE_PRIVATE11', 'SpStream',
    'ISpProperties', 'DISPID_SPPBRestorePhraseFromMemory',
    'SP_VISEME_13', 'SREStreamStart', 'Speech_StreamPos_Asap',
    'SVSFlagsAsync', 'DISPID_SOTGetAttribute', 'SPEI_END_SR_STREAM',
    'SPEI_ADAPTATION', 'DISPID_SpeechPhraseInfo', 'DISPID_SLGetWords',
    'DISPID_SRGCmdLoadFromFile', '_RemotableHandle',
    'DISPID_SVGetAudioInputs', 'DISPID_SVSInputWordLength',
    'DISPID_SRSetPropertyNumber', 'DISPID_SAEventHandle',
    'DISPID_SpeechAudio', 'SAFT44kHz8BitMono',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCERecognition',
    'SDTAlternates', 'DISPID_SPARecoResult', 'DISPID_SRRTStreamTime',
    'ISpEventSink', 'SAFTCCITT_uLaw_11kHzMono', 'SPBINARYGRAMMAR',
    'DISPID_SPEs_NewEnum', 'SASRun', 'SAFT12kHz16BitStereo',
    'DISPID_SRCEAdaptation', 'SP_VISEME_16', 'SVSFNLPMask',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPEAudioStreamOffset', 'ISpShortcut', 'SDKLLocalMachine',
    'SPWORD', 'SVP_13', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SDKDeleteKey', 'SPEI_RECO_OTHER_CONTEXT', 'SPBO_PAUSE',
    'SAFT11kHz16BitMono', 'SPEI_INTERFERENCE',
    'DISPID_SLAddPronunciation', 'SDKLDefaultLocation', 'SPCT_SLEEP',
    'SpeechBookmarkOptions', 'SRSInactiveWithPurge',
    'SAFT8kHz8BitMono', 'SVSFIsFilename', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVRate', 'DISPID_SPEAudioSizeBytes', 'DISPID_SOTSetId',
    'SPEI_MAX_SR', 'SRERequestUI', 'SpeechEngineConfidence',
    'DISPID_SPRDisplayAttributes', 'DISPID_SFSOpen', 'SPAUDIOSTATE',
    'DISPID_SLPSymbolic', 'ISpeechWaveFormatEx',
    'DISPID_SPAs_NewEnum', 'SP_VISEME_3', 'DISPID_SPEsItem', 'SVP_2',
    'SPCATEGORYTYPE', 'SpeechRuleState', 'SVSFParseAutodetect',
    'SPINTERFERENCE_TOOLOUD', 'SRSActive', 'STSF_AppData',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SGRSTransitions',
    'SRSInactive', 'SPAS_PAUSE', 'eLEXTYPE_PRIVATE2',
    ...
    'DISPID_SVEVoiceChange', 'SINoise', 'DISPID_SRRDiscardResultInfo',
    'SpeechWordType', 'SVP_19', 'DISPID_SRCEHypothesis',
    'SpeechRecognitionType', 'SAFTDefault', 'eLEXTYPE_PRIVATE1',
    'SPAUDIOOPTIONS', 'DISPID_SPRuleNumberOfElements',
    'SGRSTTDictation', 'DISPID_SCSBaseStream', 'DISPID_SRRAudio',
    'DISPID_SVAudioOutputStream', 'SGDSActive', 'SSSPTRelativeToEnd',
    'DISPID_SRAudioInputStream', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_HYPOTHESIS', 'DISPID_SDKEnumValues',
    'Speech_Default_Weight', 'DISPID_SVEventInterests', 'SDTRule',
    'SVEWordBoundary', 'DISPID_SPRuleParent', 'DISPID_SRGState',
    'SpeechAudioProperties', 'DISPID_SVSRunningState',
    'DISPID_SPAPhraseInfo', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SDKOpenKey', 'DISPID_SPPNumberOfElements', 'SDTProperty',
    'SpeechAddRemoveWord', 'SVPNormal', 'DISPID_SpeechVoice',
    'SFTSREngine', 'SVSFIsNotXML', 'SP_VISEME_7', 'SPRS_INACTIVE',
    'SPRST_NUM_STATES', 'ISpeechRecoGrammar',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SASCurrentSeekPosition',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SGRSRule', 'SPSVerb',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechLexicon',
    'SECFNoSpecialChars', 'SPPS_Noun', 'DISPID_SLWLangId',
    'DISPID_SLGetGenerationChange', 'DISPID_SABIEventBias',
    'SP_VISEME_8', 'SAFT32kHz8BitStereo', 'SPDKL_LocalMachine',
    'DISPID_SRGSetTextSelection',
    'ISpeechGrammarRuleStateTransitions', 'SpeechInterference',
    'SRTReSent', 'DISPID_SRCRecognizer', 'SRSActiveAlways',
    'ISpNotifySource', 'DISPID_SBSFormat', 'DISPID_SRAudioInput',
    'SECFIgnoreWidth', 'DISPID_SAFGuid', 'SPPS_LMA',
    'DISPID_SGRsCommit', 'DISPID_SRProfile', 'SPEI_RESERVED2',
    'SGDSInactive', 'DISPID_SGRSTWeight', 'ISpeechXMLRecoResult',
    'DISPID_SABIBufferSize', 'SpeechDictationTopicSpelling',
    'SPPARTOFSPEECH', 'SVSFPersistXML', 'SPBO_NONE', 'WAVEFORMATEX',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_START_SR_STREAM', 'SPSLMA',
    'SpSharedRecognizer', 'SpeechGrammarWordType',
    'SAFT22kHz16BitMono', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPEDisplayAttributes', 'SPRST_INACTIVE', 'ISpeechDataKey',
    'SITooQuiet', 'DISPIDSPTSI', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCRequestedUIType', 'SPSHORTCUTTYPE', 'SPPS_RESERVED3',
    'SRSEDone', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRSCurrentStreamNumber', 'SpeechDiscardType',
    'SpPhoneticAlphabetConverter', 'SAFT11kHz8BitStereo',
    'SPSHT_NotOverriden', 'SAFTExtendedAudioFormat', 'SVP_4',
    'DISPID_SVPriority', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVEStartInputStream', 'Speech_Max_Pron_Length',
    'DISPID_SAFGetWaveFormatEx', 'SDKLCurrentUser', 'SVPAlert',
    'DISPID_SRStatus', 'SPEI_SOUND_START',
    ...
    'SPPS_Unknown', 'DISPID_SRCEPropertyNumberChange',
    ...
    'eLEXTYPE_LETTERTOSOUND', 'SPCT_COMMAND', 'SPEI_RESERVED3',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPIProperties', 'DISPID_SOTCId',
    'SAFTCCITT_uLaw_22kHzMono', 'SPPHRASEELEMENT', 'SPPROPERTYINFO',
    'DISPID_SRState', 'SGRSTTWord', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechRuleAttributes', 'DISPID_SPIGrammarId',
    'ISpeechLexiconWord', 'ISpeechPhraseInfo',
    'DISPID_SRCEStartStream', 'SWTDeleted',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRIsShared', 'DISPID_SRGId', 'DISPID_SPPValue',
    'DISPID_SRCEEnginePrivate',
    'SpeechPropertyHighConfidenceThreshold', 'ISpMMSysAudio',
    'ISpeechAudio', 'SPFM_CREATE', 'SpeechAudioFormatType',
    'SREFalseRecognition', 'Speech_Max_Word_Length',
    'SPSSuppressWord', 'DISPID_SPEDisplayText', 'IEnumSpObjectTokens',
    'DISPID_SPEPronunciation', 'ISpRecoContext2', 'SRTSMLTimeout',
    'SSFMOpenForRead', 'SAFT24kHz16BitStereo', 'SBONone',
    'SP_VISEME_17', 'DISPID_SVAlertBoundary', 'SGRSTTWildcard',
    'DISPID_SpeechLexiconWords',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPRsItem',
    'DISPID_SASetState', 'SPAO_NONE', 'DISPID_SRRPhraseInfo',
    ...
    'SECHighConfidence', 'ISpRecognizer', 'SVP_21',
    'DISPID_SOTCreateInstance', 'ISpeechTextSelectionInformation',
    'SP_VISEME_19', 'SpeechGrammarTagWildcard', 'SVEEndInputStream',
    'SPEI_PHRASE_START', 'SpeechGrammarTagDictation',
    'SAFTGSM610_11kHzMono', 'SVF_Emphasis', 'SVP_17',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPPChildren',
    'SPBOOKMARKOPTIONS', 'DISPID_SRGDictationLoad',
    ...
    'DISPID_SpeechGrammarRuleState', 'SREHypothesis', 'SPSNoun',
    'DISPID_SpeechPhraseProperties', 'SRTExtendableParse',
    'SPEI_RECOGNITION', 'SpNotifyTranslator',
    '_ISpeechRecoContextEvents', 'SVP_10', 'DISPID_SOTs_NewEnum',
    'SRTAutopause', 'SVSFNLPSpeakPunc', 'SPPS_NotOverriden',
    'SPVPRI_ALERT', 'DISPID_SRRGetXMLResult',
    'DISPID_SPRFirstElement', 'DISPID_SRCRetainedAudio',
    'SPPS_Interjection', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SDKGetBinaryValue', 'SPAS_CLOSED', 'ISpeechVoiceStatus',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SGRsAdd',
    'SpeechCategoryVoices', 'DISPID_SpeechWaveFormatEx',
    'SPAR_Unknown', 'DISPID_SVSpeakStream', 'SRAExport',
    'SPRECOGNIZERSTATUS', 'SpeechTokenKeyUI',
    'ISpeechPhraseAlternate', 'eLEXTYPE_RESERVED6',
    'SECNormalConfidence', 'eLEXTYPE_USER_SHORTCUT', 'SPSUnknown',
    'DISPID_SpeechPhraseBuilder', 'SPFILEMODE', 'ISpPhraseAlt',
    'SPPHRASE', 'SAFT48kHz8BitMono', 'SPPS_SuppressWord',
    'DISPID_SRRAlternates', 'SECFIgnoreKanaType', 'DISPID_SAStatus',
    'SPPS_Noncontent', 'SPAR_High', 'SAFT48kHz8BitStereo',
    'SASClosed', 'DISPID_SVGetAudioOutputs', 'SPINTERFERENCE_NONE',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechVoiceStatus',
    'SPSTREAMFORMATTYPE', 'SPWF_SRENGINE', 'DISPID_SRCEInterference',
    'DISPID_SPCPhoneToId', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE20',
    'SAFT8kHz16BitMono', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechRecoEvents', 'SpeechRegistryLocalMachineRoot',
    'SECFIgnoreCase', 'DISPID_SPEsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechLexiconType', 'SPTEXTSELECTIONINFO', 'SpObjectToken',
    ...
    '_ISpeechVoiceEvents', 'DISPID_SVEWord',
    'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFT16kHz16BitMono', 'SPEI_REQUEST_UI', 'ISpNotifySink',
    'DISPID_SVSLastBookmark', 'ISpPhrase', 'SPEI_RESERVED1',
    'SRESoundStart', 'SPAUDIOBUFFERINFO', 'DISPID_SBSWrite',
    'DISPID_SPRuleConfidence', 'DISPID_SBSRead', 'eLEXTYPE_PRIVATE10',
    'SpInprocRecognizer', 'SGDSActiveUserDelimited',
    'SpeechGrammarRuleStateTransitionType', 'SPSMF_UPS',
    'SPEVENTENUM', 'DISPID_SRSAudioStatus',
    'DISPID_SGRsCommitAndSave', 'DISPID_SASCurrentDevicePosition',
    'SPPS_RESERVED2', 'DISPID_SVSInputWordPosition', 'SpFileStream',
    'SPXMLRESULTOPTIONS', 'SPRULESTATE', 'SSTTTextBuffer',
    'DISPID_SRCEAudioLevel', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPERetainedStreamOffset', 'SPCONTEXTSTATE', 'SASStop',
    'SPRECORESULTTIMES', 'ISequentialStream',
    'DISPID_SRSetPropertyString', 'DISPID_SVWaitUntilDone',
    'STSF_LocalAppData', 'DISPID_SPIReplacements',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_MIN_TTS', 'SPPS_RESERVED1',
    'SPPHRASERULE', 'DISPID_SPIGetText', 'ISpeechRecoResultDispatch',
    'ISpLexicon', 'SPAS_STOP', 'SPEI_SR_PRIVATE',
    'ISpeechGrammarRule', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechLexiconWord', 'SpeechCategoryRecoProfiles',
    'SVSFPurgeBeforeSpeak', 'SpeechUserTraining',
    'DISPID_SWFEAvgBytesPerSec', 'SPWORDPRONOUNCEABLE', 'IStream',
    'DISPID_SLPs_NewEnum', 'SPPS_RESERVED4', 'SpeechVisemeFeature',
    'SAFT16kHz16BitStereo', 'SAFT44kHz16BitStereo',
    'DISPID_SOTRemove', 'ISpStreamFormat', 'SRADefaultToActive',
    'DISPID_SPIRetainedSizeBytes', 'SPBO_AHEAD',
    'SPADAPTATIONRELEVANCE', 'SAFT8kHz8BitStereo',
    'SpObjectTokenCategory', 'SpeechTokenIdUserLexicon',
    'SpeechRunState', 'DISPID_SVGetVoices',
    ...
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SPIRule',
    'SAFT24kHz16BitMono', 'DISPID_SVVolume',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SOTCDefault',
    'ISpeechRecoResultTimes', 'DISPID_SPILanguageId',
    'SPDKL_CurrentUser', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SDKEnumKeys',
    'SRERecoOtherContext', 'DISPID_SPPEngineConfidence', 'SLOStatic',
    'ISpeechPhraseReplacement', 'DISPID_SpeechXMLRecoResult',
    'SVEPhoneme', 'SVP_16', 'SGLexicalNoSpecialChars',
    'DISPID_SPAStartElementInResult', 'DISPID_SGRsCount',
    'DISPID_SLWWord', 'SAFTADPCM_44kHzMono', 'DISPID_SPRuleId',
    'SPRULE', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPPFirstElement',
    'DISPID_SBSSeek', 'ISpeechGrammarRuleState',
    'DISPID_SGRSTNextState', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechGrammarRules', 'SSFMCreate', 'SFTInput',
    'DISPID_SpeechDataKey', 'DISPID_SABufferNotifySize',
    'IInternetSecurityManager', 'SpeechEngineProperties',
    'SRADynamic', 'DISPID_SVResume', 'SPGS_ENABLED',
    'ISpeechGrammarRuleStateTransition', 'ISpeechBaseStream',
    'SAFT24kHz8BitStereo', 'SPEI_MIN_SR', 'SP_VISEME_10',
    'ISpPhoneticAlphabetConverter', 'Speech_StreamPos_RealTime',
    'LONG_PTR', 'SpeechTokenShellFolder',
    'DISPID_SRCreateRecoContext', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCBookmark', 'SpeechWordPronounceable',
    'DISPID_SMSAMMHandle', 'DISPID_SVSVisemeId', 'SPEI_SR_BOOKMARK',
    'SITooLoud', 'DISPID_SGRs_NewEnum', 'SRTStandard',
    'ISpeechMMSysAudio', 'SASPause', 'ISpeechPhraseReplacements',
    'DISPID_SVSkip', 'eLEXTYPE_PRIVATE16',
    'DISPID_SGRSTPropertyValue', 'ISpPhoneConverter', 'SPSHT_OTHER',
    'SP_VISEME_9', 'DISPID_SVSPhonemeId', 'SPGRAMMARWORDTYPE',
    'SPWORDPRONUNCIATIONLIST', 'SVP_0', 'SpCustomStream',
    'DISPID_SGRInitialState', 'DISPID_SPRuleFirstElement',
    'SpeechRecoProfileProperties', 'DISPID_SOTCategory',
    'ISpeechPhraseElements', 'DISPID_SRRSaveToMemory',
    'SRAORetainAudio', 'SDTAudio', 'SP_VISEME_12',
    ...
    'DISPID_SpeechPhraseReplacements', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SLPLangId', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechPhoneConverter', 'SAFT24kHz8BitMono', 'ISpDataKey',
    'DISPID_SRCESoundEnd'
]

_check_version('1.1.14', 1633527060.442459)
